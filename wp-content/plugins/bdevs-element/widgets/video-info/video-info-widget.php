...
class Video_Info extends BDevs_El_Widget {
    ...
    protected function register_content_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'bdevs info box Sub Title goes here', 'bdevs-element' ),
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'title', 'class', 'section__title-5 mb-25 wow fadeInUp2' );
        ...
        $this->add_render_attribute('button', 'data-wow-delay', '.9s');
               ...
               <div class="row align-items-center">
                  <div class="col-xxl-5 offset-xxl-1 col-xl-5 offset-xl-1 col-lg-6 col-md-6 order-last order-md-first">
                     <div class="promotion__content-2 pr-70 mb-25">
                        <div class="section__title-wrapper section__title-wrapper-5 mb-25 wow fadeInUp2" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp2;">
                        ...
                        <?php if ( !empty($settings['sub_title']) ) : ?>
                            <p class="promotion__sub wow fadeInUp2" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp2;"><?php echo bdevs_element_kses_intermediate( $settings['sub_title'] ); ?>
                            </p>
                        <?php endif; ?>


                        <?php if ( !empty($settings['description']) ) : ?>
                            <p class="wow fadeInUp2" data-wow-delay=".7s" style="visibility: visible; animation-delay: 0.7s; animation-name: fadeInUp2;"><?php echo bdevs_element_kses_intermediate( $settings['description'] ); ?>
                            </p>
                        <?php endif; ?>
                  ...
                  <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6">
                     <div class="promotion__thumb w-img wow fadeInRight" data-wow-delay="1.2s" style="visibility: visible; animation-delay: 1.2s; animation-name: fadeInRight;">
                        ...
                        <div class="promotion__play">
                           <a href="<?php echo esc_url( $settings['video_url'] ); ?>" data-fancybox="" class="pulse-play"><i class="arrow_triangle-right"></i></a>
                        </div>
                     </div>
                  </div>
                  <?php endif; ?>
