...
class Logo_Grid extends BDevs_El_Widget {
    ...
    public function get_title() {
        return __('Logo Grid', 'bdevs-element');
    }
    ...
    protected function register_content_controls() {
        $this->start_controls_section(
            '_section_logo',
            [
                'label' => __( 'Logo Grid', 'bdevs-element' ),
        ...
        $repeater->add_control(
            'link',
            [
                'label' => __('Website Url', 'bdevs-element'),
        ...
        $repeater->add_control(
            'name',
            [
                'label' => __('Brand Name', 'bdevs-element'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Brand Name', 'bdevs-element'),
            ]
        );
        ...
        $this->add_control(
            'layout',
            [
                'label' => __( 'Grid Layout', 'bdevs-element' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'box' => __( 'Box', 'bdevs-element' ),
                    'border' => __( 'Border', 'bdevs-element' ),
                    'tictactoe' => __( 'Tic Tac Toe', 'bdevs-element' ),
                ],
                'default' => 'box',
        ...
        $this->add_responsive_control(
            'columns',
            [
                'label' => __( 'Columns', 'bdevs-element' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    2 => __( '2 Columns', 'bdevs-element' ),
                    3 => __( '3 Columns', 'bdevs-element' ),
                    4 => __( '4 Columns', 'bdevs-element' ),
                    5 => __( '5 Columns', 'bdevs-element' ),
                    6 => __( '6 Columns', 'bdevs-element' ),
                ],
                'desktop_default' => 4,
                'tablet_default' => 2,
                'mobile_default' => 2,
    ...
    protected function register_style_controls() {
        ...
        $this->add_control(
            'grid_border_type',
            [
                'label' => __( 'Border Type', 'bdevs-element' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'none' => __( 'None', 'bdevs-element' ),
                    'solid' => __( 'Solid', 'bdevs-element' ),
                    'double' => __( 'Double', 'bdevs-element' ),
                    'dotted' => __( 'Dotted', 'bdevs-element' ),
                    'dashed' => __( 'Dashed', 'bdevs-element' ),
                    'groove' => __( 'Groove', 'bdevs-element' ),
                ],
                'default' => 'solid',
                'selectors' => [
        ...
        $this->add_responsive_control(
            'grid_border_width',
            [
                'label' => __( 'Border Width', 'bdevs-element' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'selectors' => [
