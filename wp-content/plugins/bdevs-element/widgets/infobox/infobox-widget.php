...
class InfoBox extends BDevs_El_Widget
{
    ...
    protected function render()
    {
        ...
        if (!empty($settings['button_link'])) {
            $this->add_render_attribute('button', 'class', 'text_btn bdevs-el-btn');
        ...
        <div class="feature_listlayout_boxed2 deco_wrap">
            ...
            <div class="item_content bdevs-el-content">
                <?php if ($settings['sub_title']) : ?>
                    <span class="item_type bdevs-el-subtitle"><?php echo bdevs_element_kses_basic($settings['sub_title']); ?></span>
                <?php endif; ?>
        ...
        <div class="blog__wrapper white-bg mb-30 transition-3">
            ...
            <div class="blog__single">
               ...
               <h3 class="blog__title">
                  <a class="bdevs-el-title" href="<?php echo esc_url( $slide['title_url'] ); ?>"><?php echo bdevs_element_kses_intermediate( $slide['title'] ); ?></a>
               </h3>
            </div>
            <?php endforeach; ?>
        </div>
