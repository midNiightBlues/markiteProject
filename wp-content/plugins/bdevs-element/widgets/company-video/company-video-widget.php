...
class Company_Video extends BDevs_El_Widget {
    ...
    public function get_title() {
        return __( 'Comapny Video', 'bdevs-element' );
    }
    ...
    protected function register_content_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Big Title', 'bdevs-element' ),
                'placeholder' => __( 'Big Title', 'bdevs-element' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->start_controls_section(
            '_section_profile',
            [
                'label' => __( 'Profile Info', 'bdevs-element' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'profile_title',
            [
                'label' => __( 'Profile Title', 'bdevs-element' ),
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'bdevs Info Box Title', 'bdevs-element' ),
                'placeholder' => __( 'Type Info Box Title', 'bdevs-element' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Shadow Title', 'bdevs-element' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Type Video URL Here', 'bdevs-element' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
    ...
    protected function register_style_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Icon / profile_image', 'bdevs-element' ),
