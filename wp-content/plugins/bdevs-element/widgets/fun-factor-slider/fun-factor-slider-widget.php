...
class Fun_Factor_Slider extends BDevs_El_Widget {
	...
	public function get_title() {
		return __('Fun Fact Slider', 'bdevs-element');
	}
	...
	protected function register_content_controls() {
		$this->start_controls_section(
			'_section_contents',
			[
				'label' => __('Contents', 'bdevs-element'),
		...
		$this->add_control(
			...
			[
				...
				'default' => __('bdevs Clients', 'bdevs-element'),
			]
		);
		...
		$this->add_control(
			'animate_number',
			[
				'label'        => __('Animate', 'bdevs-element'),
		...
		$this->add_control(
			'animate_duration',
			[
				'label'     => __('Duration', 'bdevs-element'),
		...
		$this->start_controls_section(
			'_section_options',
			[
				'label' => __('Options', 'bdevs-element'),
				'tab'   => Controls_Manager::TAB_CONTENT
			]
		);
		...
		$this->add_responsive_control(
			'text_align',
			[
				'label'       => __('Text Alignment', 'bdevs-element'),
				'type'        => Controls_Manager::CHOOSE,
				'options'     => [
					'left'   => [
						'title' => __('Left', 'bdevs-element'),
		...
		$this->add_control(
			'divider_show_hide',
			[
				'label'        => __('Show Divider', 'bdevs-element'),
				'type'         => Controls_Manager::SWITCHER,
	...
	protected function register_style_controls() {
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label'           => __('Size (em)', 'bdevs-element'),
				'type'            => Controls_Manager::SLIDER,
				'size_units'      => ['em'],
				'range'           => [
					'em' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Number & Title', 'bdevs-element'),
				'tab'   => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->start_controls_section(
			'_section_divider',
			[
				'label'     => __('Divider', 'bdevs-element'),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
