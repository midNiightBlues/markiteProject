...
class History extends BDevs_El_Widget {
    ...
    public function get_title() {
        return __( 'History', 'bdevs-element' );
    }
	...
	protected function register_content_controls() {
        ...
        $this->add_control(
            'show_exp',
            [
                'label' => __( 'Show Experience Box?', 'bdevs-element' ),
        ...
        $this->add_control(
            'exp_title',
            [
                'label' => __( 'Experience Title', 'bdevs-element' ),
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Years Of Experience', 'bdevs-element' ),
                'placeholder' => __( 'Type Number', 'bdevs-element' ),
                'condition' => [
                    'design_style' => 'style_2',
                    'show_exp' => 'yes',
        ...
        $this->start_controls_section(
            '_section_profile',
            [
                'label' => __( 'Profile', 'bdevs-element' ),
                'tab' => Controls_Manager::TAB_CONTENT,
                'condition' => [
        ...
        $this->add_control (
            'profile_position',
            [
                'label' => __( 'Profile Position', 'bdevs-element' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'left' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Name Here', 'bdevs-element' ),
                'placeholder' => __( 'Type Name Title', 'bdevs-element' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            'designation',
            [
                'label' => __( 'Designation', 'bdevs-element' ),
                'description' => bdevs_element_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXTAREA,
                'default' => __( 'designation', 'bdevs-element' ),
                'placeholder' => __( 'Type designation', 'bdevs-element' ),
                'rows' => 5,
                'dynamic' => [
                    'active' => true,
                ]
        ...
        $this->add_control (
            'sign_position',
            [
                'label' => __( 'Signature Position', 'bdevs-element' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'left' => [
        ...
        $this->add_control(
            'name_tag',
            [
                'label' => __( 'Name HTML Tag', 'bdevs-element' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'h1'  => [
                        'title' => __( 'H1', 'bdevs-element' ),
        ...
        $this->add_responsive_control(
            'profile_align',
            [
                'label' => __( 'Profile Alignment', 'bdevs-element' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __( 'Left', 'bdevs-element' ),
