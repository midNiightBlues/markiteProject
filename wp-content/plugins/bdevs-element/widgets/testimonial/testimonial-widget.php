...
class Testimonial extends BDevs_El_Widget {
    ...
    public function get_title() {
        return __( 'Testimonial', 'bdevs-element' );
    }
	...
	protected function register_content_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Testimonial', 'bdevs-element' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Testimonial contents', 'bdevs-element' ),
                'placeholder' => __( 'Type testimonial', 'bdevs-element' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            '_design',
            [
                'label' => __( 'Design', 'bdevs-element' ),
                'type' => Controls_Manager::SELECT,
                'label_block' => false,
                'options' => [
                    'basic' => __( 'Default', 'bdevs-element' ),
                    'bubble' => __( 'Bubble', 'bdevs-element' ),
                ],
                'default' => 'basic',
                'prefix_class' => 'bdevs-testimonial--',
                'style_transfer' => true,
        ...
        $this->start_controls_section(
            '_section_reviewer',
            [
                'label' => __( 'Reviewer', 'bdevs-element' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'bdevs', 'bdevs-element' ),
                'placeholder' => __( 'Type Reviewer Name', 'bdevs-element' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'CMO, BdevsElement', 'bdevs-element' ),
                'placeholder' => __( 'Type reviewer title', 'bdevs-element' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
