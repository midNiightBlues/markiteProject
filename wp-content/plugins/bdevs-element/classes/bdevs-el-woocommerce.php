    ...
    public static function add_to_cart_hover_button($product_id)
    {
        if (BDEVSEL_WOOCOMMERCE_ACTIVED) {
            ...
            if ($product) {
                ...
                return sprintf('<a rel="nofollow" data-toggle="tooltip" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" class="%s p-btn-white add_to_cart_button bdevs-btn">'.esc_html__('buy now','bdevs-element').'</a>',
    ...
    public static function add_to_cart_button($product_id)
    {
        if (BDEVSEL_WOOCOMMERCE_ACTIVED) {
            ...
            if ($product) {
                ...
                return sprintf('<a rel="nofollow" data-toggle="tooltip" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" class="%s m-btn m-btn-5 add_to_cart_button bdevs-btn">'.esc_html__('buy now','bdevs-element').'</a>',
                    esc_url($product->add_to_cart_url()),
                    esc_attr(isset($quantity) ? $quantity : 1),
                    esc_attr($product->get_id()),
                    esc_attr($product->get_sku()),
