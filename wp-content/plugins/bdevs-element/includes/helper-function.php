...
function bdevs_element_get_allowed_html_desc($level = 'basic')
{
    ...
    return sprintf(__('This input field has support for the following HTML tags: %1$s', 'bdevs-element'), '<code>' . esc_html($tags_str) . '</code>');
}
...
function element_pack_position()
{
    ...
    $position_options = [
        '' => esc_html__('Default', 'bdevs-element'),
        'top-left' => esc_html__('Top Left', 'bdevs-element'),
        'top-center' => esc_html__('Top Center', 'bdevs-element'),
        'top-right' => esc_html__('Top Right', 'bdevs-element'),
        'center' => esc_html__('Center', 'bdevs-element'),
        'center-left' => esc_html__('Center Left', 'bdevs-element'),
        'center-right' => esc_html__('Center Right', 'bdevs-element'),
        'bottom-left' => esc_html__('Bottom Left', 'bdevs-element'),
        'bottom-center' => esc_html__('Bottom Center', 'bdevs-element'),
        'bottom-right' => esc_html__('Bottom Right', 'bdevs-element'),
    ];
