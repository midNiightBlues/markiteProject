<?php
	...
	class Bdevs_Subscriber_Widget  extends WP_Widget{
		...
		public function __construct(){
			parent::__construct('bdevs_subscriber_widget',esc_html__('Markite Subscriber','bdevs-toolkit'),array(
				'description' => esc_html__('Markite Subscriber Widget','bdevs-toolkit'),
			));
		}
		...
		?>
				...
				<div class="footer__subscribe">
                    ...
                    <p><?php print wp_kses_post($mailchimp_text); ?></p>
                    <?php endif; ?>
