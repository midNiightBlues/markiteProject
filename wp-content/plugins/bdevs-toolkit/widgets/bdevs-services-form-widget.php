<?php
	...
	class bdevs_services_form_widget  extends WP_Widget{
		...
		public function __construct(){
			parent::__construct('bdevs_services_form_widget',esc_html__('Zibber Services Form','bdevs-toolkit'),array(
				'description' => esc_html__('Zibber Services Form Widget','bdevs-toolkit'),
			));
		}
